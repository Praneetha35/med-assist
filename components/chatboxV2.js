...
export const ChatBoxV2 = () => {
    const [messages, setMessages] = useState([
      {
        role: 'assistant',
        content: [{"text": 'Hello! I am your First Aid Assistant. How can I help you with emergency advice today?'}]
      }
    ]);
      ...
      if (message.trim()) {
        ...
        try {
          ...
          setMessages((prevMessages) => [
            ...prevMessages,
            { role: 'assistant', content: [{text: updatedMessage}], id: messageId },
          ]);
          ...
          while (true) {
            ...
            setMessages((prevMessages) => 
              prevMessages.map((msg) =>
                msg.id === messageId ? { ...msg, content: [{text:updatedMessage}] } : msg
              )
            );
          }
